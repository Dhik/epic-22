		...
		<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
				...
				<div class="card mx-auto">
					...
					<div class="card-body">
						<div class="card-title">
							<h4 class="theme_competition">Pre Event</h4>
						</div>
					</div>
					<div class="card-footer">
						<a href="{{ route('pre_event')}}" class="btn-block btn-read mt-2 py-2 mx-auto">
							<p>Read More</p>
						</a>
					</div>
				</div>
			...
			<div class="col-md-4 col-sm-6 col-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="200">
				<div class="card mx-auto">
					...
					<div class="card-body">
						<div class="card-title">
							<h4 class="theme_competition">Main Event</h4>
						</div>
					</div>
					<div class="card-footer">
						<a href="{{ route('main_event')}}" class="btn-block btn-read mt-2 py-2 mx-auto">
							<p>Read More</p>
						</a>
					</div>
				</div>
			...
			<div class="col-md-4 col-sm-6 col-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="200">
				<div class="card mx-auto">
					...
					<div class="card-body">
						<div class="card-title">
							<h4 class="theme_competition">Closing</h4>
						</div>
					</div>
					<div class="card-footer">
						<a href="{{ route('closing')}}" class="btn-block btn-read mt-2 py-2 mx-auto">
							<p>Read More</p>
						</a>
					</div>
				</div>
